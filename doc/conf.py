...
html_theme_options = {
    ...
    # an arbitrary url.
    'navbar_links': [
        ("GitHub", "https://github.com/datamicroscopes", True),
        ("Qadium", "https://qadium.com/", True),
    ],
...
html_short_title = 'microscopes'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
# html_logo = "qadium-logo.png"
